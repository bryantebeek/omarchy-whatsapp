...
MUTATIONS = [
    ...
    mutation("panel-receipt-tooltip-status", P, TC, "var lines = [root.messageReceiptLabel(message ? message.receipt : 0)]", "var lines = []"),
    mutation("panel-receipt-tooltip-delivery", P, TC, 'if (deliveredAt) lines.push("Delivered at " + deliveredAt)', 'if (!deliveredAt) lines.push("Delivered at " + deliveredAt)'),
