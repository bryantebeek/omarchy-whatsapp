...
TestCase {
  ...
  function test_panel_loads() {
    ...
    verify(panel.isChatSearchShortcut(Qt.Key_F))
    verify(panel.isChatSearchShortcut(Qt.Key_K))
    verify(panel.isChatSearchShortcut(Qt.Key_L))
    verify(!panel.isChatSearchShortcut(Qt.Key_A))
